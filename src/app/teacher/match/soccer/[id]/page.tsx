      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8 max-w-7xl">
        <div className="flex items-center gap-4 mb-4 print-hidden">
          <div>
            ...
            <p className="text-muted-foreground">기록할 팀과 전/후반을 선택하고, 선수별 성적을 입력하세요.</p>
          </div>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Select value={selectedHalf} onValueChange={setSelectedHalf}>
                ...
                <SelectContent>
                  <SelectItem value="1">전반</SelectItem>
                  <SelectItem value="2">후반</SelectItem>
                </SelectContent>
              </Select>
                ...
                <Select value={printView} onValueChange={setPrintView}>
                  ...
                  <SelectContent>
                    ...
                    {Object.keys(matchStats).map(qNum => (
                        <SelectItem key={qNum} value={qNum}>{qNum === '1' ? '전반' : '후반'}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
        ...
        <div id="print-area">
            <div className="print-only mb-4 hidden">
                ...
                <h3 className="text-xl">{(teamForPrint?.name)} 팀 기록지 - {printView === 'final' ? '최종 합계' : (printView === '1' ? '전반' : '후반')}</h3>
            </div>
            <Card>
